...
|---|---|---|
| Windows | `dicom-dose-audit-windows.zip` | `DicomDoseAudit.exe` and bundled runtime files |
| macOS | `dicom-dose-audit-macos.dmg` | `DicomDoseAudit.app` |
| Linux | `dicom-dose-audit-linux.tar.gz` | `DicomDoseAudit` executable bundle |
...
- Real DICOM-derived CSVs should only be used under appropriate institutional approval and privacy controls.
