...
def build_ct_image_dataset(
    *,
    ...
    # Encode protocol version in ProtocolName using the "::" convention that
    # many institutions use for versioned protocols (e.g. "CT Head :: v2").
    protocol_label = f"{protocol} :: {protocol_version}" if protocol_version else protocol
    ds.ProtocolName = protocol_label
